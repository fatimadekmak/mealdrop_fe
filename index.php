        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 ftco-animate">
              ...
              <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Browse Italian Meals</a></p>
            </div>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 order-md-last ftco-animate">
              ...
              <h1 class="mb-4">KFC</h1>
              <p class="mb-4 mb-md-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, corrupti quasi tempore porro, vel iure laudantium adipisci recusandae repudiandae nesciunt voluptatibus.</p>
